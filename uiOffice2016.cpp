...
uiOffice2016::uiOffice2016()
{
	...
	QAction* tActSave = new QAction(QIcon(":/QRibbionGUI/bin/userdata/img/save.png"), "Save");
	QAction* tActUndo = new QAction(QIcon(":/QRibbionGUI/bin/userdata/img/Undo.png"), "Undo");
	QAction* tActRedo = new QAction(QIcon(":/QRibbionGUI/bin/userdata/img/Redo.png"), "Redo");
	tBar->addQuickAction(tActSave);
	tBar->addQuickAction(tActUndo);
	tBar->addQuickAction(tActRedo);
	QAction* tActClose = new QAction(QIcon(":/QRibbionGUI/bin/userdata/img/TitleCloseButton.png"), "Close");
	QAction* tActMax = new QAction(QIcon(":/QRibbionGUI/bin/userdata/img/TitleMaxButton.png"), "Max");
	QAction* tActSkin = new QAction(QIcon(":/QRibbionGUI/bin/userdata/img/Skin.png"), "Skin");
	...
	QIcon tIcon = QIcon(":/QRibbionGUI/bin/userdata/img/brush.png");

	QtbMenuBar* tMenuBar = menuBar();

	tMenuBar->setExtentBtnIcon(QIcon(":/QRibbionGUI/bin/userdata/img/iconExtent.png"), QIcon(":/QRibbionGUI/bin/userdata/img/iconHide.png"));
	...
	if (tGW)
	{
		ribbonAction* tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/ruanjian.png"), "粘贴");
		...
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/cut.png"), "剪切");
		tGW->addAction(tAct, 0, 1, 1, 1);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/copy.png"), "复制");
		tGW->addAction(tAct, 1, 1, 1, 1);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/brush.png"), "格式刷");
	...
	if (tGW)
	{
		...
		tGW->addAction(tAct, tRow, tCol++);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/zoomin.png"), "放大");
		tGW->addAction(tAct, tRow, tCol++);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/zoomout.png"), "缩小");
		tGW->addAction(tAct, tRow, tCol++);

		tRow = 1;
		tCol = 0;
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "加粗");
		tGW->addAction(tAct, tRow, tCol++);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "斜体");
		tGW->addAction(tAct, tRow, tCol++);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "下划线");
		tGW->addAction(tAct, tRow, tCol++);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "删除线");
		tGW->addAction(tAct, tRow, tCol++);
	}
	...
	{
		int tRow = 0, tCol = 0;
		ribbonAction* tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "符号");
		tGW->addAction(tAct, tRow, tCol++);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "编号");
		tGW->addAction(tAct, tRow, tCol++);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "列表");
		tGW->addAction(tAct, tRow, tCol++);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "缩进");
		tGW->addAction(tAct, tRow, tCol++);

		tRow = 1;
		tCol = 0;
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "左对齐");
		tGW->addAction(tAct, tRow, tCol++);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "居中");
		tGW->addAction(tAct, tRow, tCol++);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "右对齐");
		tGW->addAction(tAct, tRow, tCol++);
	}
	tGW = tMenuBar->addGroup("开始", "样式");
	if (tGW)
	{
		ribbonAction* tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "正文");
		tGW->addAction(tAct, 0, 0);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "标题1");
		tGW->addAction(tAct, 0, 1);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "标题2");
		tGW->addAction(tAct, 0, 2);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "标题3");
		tGW->addAction(tAct, 0, 3);
	}
	tGW = tMenuBar->addGroup("开始", "编辑");
	if (tGW)
	{
		ribbonAction* tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "查找");
		tGW->addAction(tAct, 0, 0);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "替换");
		tGW->addAction(tAct, 1, 0);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "选择");
	...
	if (tGW)
	{
		...
		tGW->addAction(tAct, 0, 0, 3, 1);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "剪切");
		tGW->addAction(tAct, 0, 1, 1, 1);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "复制");
		tGW->addAction(tAct, 1, 1, 1, 1);
		tAct = new RibbonToolButton(QIcon(":/QRibbionGUI/bin/userdata/img/down.png"), "粘贴");
		tGW->addAction(tAct, 2, 1, 1, 1);
	}
...
void uiTEST_MainWindow::initTitleBar()
{
    ...
    QAction* tActClose = new QAction(QIcon(":/QRibbionGUI/bin/userdata/img/TitleCloseButton.png"), "Close");
    QAction* tActMax = new QAction(QIcon(":/QRibbionGUI/bin/userdata/img/TitleMaxButton.png"), "Max");
    QAction* tActMin = new QAction(QIcon(":/QRibbionGUI/bin/userdata/img/TitleMinButton.png"), "Min");
	QAction* tActSkin = new QAction(QIcon(":/QRibbionGUI/bin/userdata/img/Skin.png"), "Skin");
    // 先加的在右边
    tBar->addSysAction(tActClose);
    QObject::connect(tActClose, SIGNAL(triggered()), this, SLOT(close()));
...
void uiTEST_MainWindow::initMenuBar()
{
    ...
    {
        int tCol = 0;
        tIconBig = QIcon(":/QRibbionGUI/bin/userdata/img/menu_model_train.png");
    ...
    if (tGW)
    {
        ...
        tIconBig = QIcon(":/QRibbionGUI/bin/userdata/img/menu_predict_model.png");
        ...
        tIconBig = QIcon(":/QRibbionGUI/bin/userData/img/menu_predict_data.png");
        ...
        tIconBig = QIcon(":/QRibbionGUI/bin/userData/img/menu_predict.png");
    ...
    {
        int tCol = 0;
        tIconBig = QIcon(":/QRibbionGUI/bin/userData/img/menu_show_section1.png");
        ...
        tIconBig = QIcon(":/QRibbionGUI/bin/userData/img/menu_show_section2.png");
...
{
    QIcon tIcon0 = QIcon(":/QRibbionGUI/bin/userData/img/icon/tree_item_top.png");
    QIcon tIcon1 = QIcon(":/QRibbionGUI/bin/userData/img/icon/tree_item.png");
...
{
    QString layoutFile = "E:\\VS project\\Qt-wps style project\\Qt5Project\\x64\\Debug\\msqcMain.layout.dat";
    if (isSave)
    {
